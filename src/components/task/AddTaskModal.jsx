...
function AddTaskModal({handleClick}) {
  return (
    <div onClick={() => handleClick(false)} className="fixed inset-0 bg-[#000000b7] z-50 overflow-y-hidden flex items-center justify-center">
        <form
